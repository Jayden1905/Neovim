...
local config = {
	...
	settings = {
		java = {
			...
			home = "/Users/kyawzayannaing/.sdkman/candidates/java/current",
			eclipse = {
			...
			configuration = {
				...
				runtimes = {
					{
						name = "JavaSE-11",
						path = "/Users/kyawzayannaing/.sdkman/candidates/java/current",
					},
					{
						name = "JavaSE-17",
						path = "/Users/kyawzayannaing/.sdkman/candidates/java/current",
...
-- 		"-Dlog.protocol=true",
-- 		"-Dlog.level=ALL",
-- 		"-javaagent:" .. home .. "/Users/kyawzayannaing/.local/share/nvim/mason/packages/jdtls/lombok.jar",
-- 		"-Xms1g",
-- 		"--add-modules=ALL-SYSTEM",
-- 		"--add-opens",
-- 		"java.base/java.util=ALL-UNNAMED",
...
-- 		vim.fn.glob(
-- 			home
-- 				.. "/Users/kyawzayannaing/.local/share/nvim/mason/packages/jdtls/plugins/org.eclipse.equinox.launcher_*.jar"
-- 		),
-- 		-- ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^                                       ^^^^^^^^^^^^^^
...
-- 		-- 💀
-- 		"-configuration",
-- 		home .. "/Users/kyawzayannaing/.local/share/nvim/mason/packages/jdtls/config_" .. CONFIG,
-- 		-- ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^        ^^^^^^
